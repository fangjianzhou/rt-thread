...
/* spinlock */
#ifdef RT_USING_SMP
#define spinlock_t rt_hw_spinlock_t
#else
...
static inline void ___writel(rt_uint32_t value, volatile void *addr)
{
...
static inline void ___writew(rt_uint16_t value, volatile void *addr)
{
...
static inline void ___writeb(rt_uint8_t value, volatile void *addr)
{
...
static inline rt_uint8_t ___readb(const volatile void *addr)
{
...
static inline rt_uint16_t ___readw(const volatile void *addr)
{
...
static inline rt_uint32_t ___readl(const volatile void *addr)
{
...
extern unsigned long __virt_to_phys(volatile void *address);
#define virt_to_phys __virt_to_phys
...
({ \
    rt_uint64_t __timeout_us = (timeout_us); \
