...
static int rockchip_hwspinlock_drv_register(void)
{
    rt_platform_driver_register(&rockchip_hwspinlock_driver);

    return 0;
}
INIT_FRAMEWORK_EXPORT(rockchip_hwspinlock_drv_register);
