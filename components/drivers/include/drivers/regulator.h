...
struct rt_regulator_ops
{
    rt_err_t    (*enable)(struct rt_regulator_node *);
    rt_err_t    (*disable)(struct rt_regulator_node *);
    rt_bool_t   (*is_enabled)(struct rt_regulator_node *);
    rt_err_t    (*set_voltage)(struct rt_regulator_node *, int min_uvolt, int max_uvolt);
    int         (*get_voltage)(struct rt_regulator_node *);
};
