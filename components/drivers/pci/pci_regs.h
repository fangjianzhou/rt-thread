...
#define PCIM_BAR_MEM_PREFETCH       0x08    /* prt_refetchable? */
...
#define PCIM_EA_P_MEM                   0x00    /* Non-Prt_refetch Memory */
#define PCIM_EA_P_MEM_PREFETCH          0x01    /* Prt_refetchable Memory */
#define PCIM_EA_P_IO                    0x02    /* I/O Space */
#define PCIM_EA_P_VF_MEM_PREFETCH       0x03    /* VF Prt_refetchable Memory */
#define PCIM_EA_P_VF_MEM                0x04    /* VF Non-Prt_refetch Memory */
#define PCIM_EA_P_BRIDGE_MEM            0x05    /* Bridge Non-Prt_refetch Memory */
#define PCIM_EA_P_BRIDGE_MEM_PREFETCH   0x06    /* Bridge Prt_refetchable Memory */
...
#define PCIR_AER_TLP_PREFIX_LOG             0x38    /* Only for TLP prt_refix functions */
