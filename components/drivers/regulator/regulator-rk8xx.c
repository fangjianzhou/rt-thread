...
{
    RK8XX_REGULATOR_VOLT_RANGES("dcdc-reg1", "vcc1", rk8xx_regulator_wmsk_ops,
...
static rt_err_t rk8xx_regulator_probe(struct rt_platform_device *pdev)
{
    ...
    struct rt_ofw_node *np, *regulators_np = rk8xx->priv;
