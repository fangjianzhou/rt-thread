...
rt_err_t sdio_dw_platfrom_register(struct rt_platform_device *pdev,
...
static rt_err_t sdio_dw_platfrom_probe(struct rt_platform_device *pdev)
{
...
static const struct rt_ofw_node_id sdio_dw_platfrom_ofw_ids[] =
{
...
static struct rt_platform_driver sdio_dw_platfrom_driver =
{
    .name = "dw-mmc",
    .ids = sdio_dw_platfrom_ofw_ids,

    .probe = sdio_dw_platfrom_probe,
};
RT_PLATFORM_DRIVER_EXPORT(sdio_dw_platfrom_driver);
