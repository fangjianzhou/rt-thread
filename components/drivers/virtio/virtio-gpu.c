...
static rt_err_t virtio_gpu_unrt_ref_resource(struct virtio_gpu_device *virtio_gpu_dev, rt_uint32_t resource_id)
{
    struct virtio_gpu_ctrl_hdr res;
    struct virtio_gpu_resource_unrt_ref req;
...
static rt_err_t virtio_gpu_control(rt_device_t dev, int cmd, void *args)
{
    ...
    case VIRTIO_DEVICE_CTRL_GPU_CREATE_2D:
        ...
        {
            virtio_gpu_unrt_ref_resource(virtio_gpu_dev, virtio_gpu_dev->display_resource_id);
